...
function User({ setShow, show, active }) {
  ...
  return (
    <>
      <div
        className={`absolute top-full right-0 mt-2 w-56 z-50 transition-all duration-300 ease-out origin-top-right ${active ? "" : "invisible opacity-0 translate-y-3"}`}
      >
        ...
        <div className="relative bg-white border border-gray-100 rounded-xl shadow-xl overflow-hidden">
          ...
          <div className="p-2">
            <div
              className="flex items-center justify-between p-2 rounded-lg hover:bg-red-50 group/item cursor-pointer transition-colors"
              onClick={() => {
                console.log("clicked");
                setShow(!show);
              }}
            ...
            <div className="mt-2 pt-2 border-t border-gray-100">
              <button
                className="w-full flex items-center justify-between p-2 rounded-lg hover:bg-gray-100 text-gray-700 transition-colors"
                onClick={logout}
              >
